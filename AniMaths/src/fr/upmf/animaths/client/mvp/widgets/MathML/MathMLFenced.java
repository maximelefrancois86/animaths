...
public class MathMLFenced extends MathMLElement {

	static String elementName="mfenced";

	public MathMLFenced(MathObjectElement element) {
	...
	public MathMLFenced clone(MathObjectElement element) {
		return new MathMLFenced(element);
	}
