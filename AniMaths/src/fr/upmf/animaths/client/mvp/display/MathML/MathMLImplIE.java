...
// An implementation to handle MathPlayer tags in IE
public class MathMLImplIE extends MathMLImpl{

	public MathMLImplIE() {
	}
	
	Element createElement(String tag) {
//		RootPanel.get("MathDiv").add(new HTML("on travaille avec MathMLImplIE"));	
