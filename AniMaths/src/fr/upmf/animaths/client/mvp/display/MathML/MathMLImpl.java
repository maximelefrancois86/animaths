...
public abstract class MathMLImpl extends Widget{

	private static MathMLImpl impl = GWT.create(MathMLImpl.class);

	public static MathMLImpl getInstance() {
		return impl;
	}

	 native Element createElementNS (String ns, String tag) /*-{
	            return $doc.createElementNS(ns, tag);
	        }-*/;

	abstract Element createElement(String tag);
