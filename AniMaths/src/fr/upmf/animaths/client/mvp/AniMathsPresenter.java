...
public class AniMathsPresenter extends WidgetPresenter<AniMathsPresenter.Display> {
	...
	private DynamicMathObjectPresenter dynamicMathObjectPresenter;
	...
	protected void onBind() {
		...
		dynamicMathObjectPresenter = new DynamicMathObjectPresenter();
		dynamicMathObjectPresenter.setElement(eq);
