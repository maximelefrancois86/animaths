...
public class MathMLGenericList extends MathMLElement {

	public MathMLGenericList(String elementName) {
		super(elementName);
	}

	public MathMLGenericList(String elementName, List<MathMLElement> children) {
		this(elementName);
		setChildren(children);
	}

	public MathMLGenericList(String elementName, MathMLElement child) {
		this(elementName);
		clear();
		addChild(child);
	}

	public void setChildren(List<MathMLElement> children) {
		clear();
		for(int i=0;i<children.size();i++)
			addChild(children.get(i));
	}

	public void addChild(MathMLElement child) {
		add(child);
	}
}
