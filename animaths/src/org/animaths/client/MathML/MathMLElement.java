...
public class MathMLElement extends ComplexPanel{
	
	public static MathMLImpl impl = MathMLImpl.getInstance();

	MathObjectElement mathObjectElement;
	...
	public void setMathObjectElement(MathObjectElement mathObjectElement) {
		this.mathObjectElement = mathObjectElement;
	}
