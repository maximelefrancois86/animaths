...
public abstract class MathMLGenericOneChild extends MathMLElement {
	
	public MathMLGenericOneChild(String elementName) {
		super(elementName);
	}

	public MathMLGenericOneChild(String elementName, MathMLElement child) {
		this(elementName);
		setChild(child);
	}
	
	public void setChild(MathMLElement child) {
		clear();
		add(child);
	}
